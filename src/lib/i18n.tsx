...
export const dictionaries = {
  en: {
    nav: { how: "How it works", impact: "For your MP", submit: "Raise your voice", signIn: "Sign in", profile: "Profile" },
    hero: {
    ...
    submit: {
      ...
      constituencyLabel: "Your constituency",
      constituencyPlaceholder: "Select your constituency…",
      constituencyHint: "Official Lok Sabha constituency — your issue routes to this constituency's MP.",
    ...
    onboarding: {
      ...
      aadhaarTag: "optional",
      aadhaarHint: "Adding Aadhaar lets you submit verified suggestions later. It is never shown publicly.",
      save: "Save & continue",
      skip: "Skip for now",
    ...
    dash: {
      ...
      medium: "Medium",
      low: "Low",
      factors: { D: "Demand", G: "Service gap", P: "Population", E: "Equity", C: "Corroboration", F: "Feasibility", M: "Momentum" },
      factorsShort: { D: "Demand", G: "Gap", P: "Pop.", E: "Equity", C: "Corrob.", F: "Feasib.", M: "Trend" },
      office: "MP office",
    },
    lang: "Language",
  },
  hi: {
    nav: { how: "यह कैसे काम करता है", impact: "आपके सांसद के लिए", submit: "अपनी आवाज़ उठाएँ", signIn: "साइन इन", profile: "प्रोफ़ाइल" },
    hero: {
    ...
    submit: {
      ...
      constituencyLabel: "आपका निर्वाचन क्षेत्र",
      constituencyPlaceholder: "अपना निर्वाचन क्षेत्र चुनें…",
      constituencyHint: "आधिकारिक लोकसभा क्षेत्र — आपकी शिकायत इसी क्षेत्र के सांसद को भेजी जाएगी।",
    ...
    onboarding: {
      ...
      aadhaar: "आधार नंबर",
      aadhaarTag: "वैकल्पिक",
      aadhaarHint: "आधार जोड़ने से आप बाद में सत्यापित सुझाव भेज सकते हैं। यह कभी सार्वजनिक नहीं दिखाया जाता।",
    ...
    dash: {
      ...
      medium: "मध्यम",
      low: "निम्न",
      factors: { D: "माँग", G: "सेवा कमी", P: "जनसंख्या", E: "समता", C: "पुष्टि", F: "व्यवहार्यता", M: "गति" },
      factorsShort: { D: "माँग", G: "कमी", P: "जन.", E: "समता", C: "पुष्टि", F: "व्यवहार्य", M: "रुझान" },
